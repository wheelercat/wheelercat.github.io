...
```{r,  label = "tempandtrips", fig.cap = "Mean Temperature vs. Number of Trips", echo = FALSE}
trip_weather %>% 
...
```{r,  label = "tempandnumber", fig.cap = "Standardization of Temperature and Number of Trips", echo = FALSE}
t1 <- trip_weather %>% 
...
```{r,  label = "precipvsnumber", fig.cap = "Precipitation vs. Number of Trips", echo = FALSE}
t2 <- trip_weather %>% 
